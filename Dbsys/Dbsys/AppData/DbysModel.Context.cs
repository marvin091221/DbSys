...
public partial class DBSYSEntities : DbContext
{
    ...
    public DbSet<view_all_user_role> view_all_user_role { get; set; }
    ...
    public virtual int sp_CreateUser(string userName, string userPassword, string userStatus, Nullable<int> roleId, Nullable<int> createdBy)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_CreateUser1", userNameParameter, userPasswordParameter, userStatusParameter, roleIdParameter, createdByParameter);
    }
